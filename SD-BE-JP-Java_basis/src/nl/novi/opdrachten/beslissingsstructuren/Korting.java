...
public class Korting {
    public static void main(String[] args) {
        ...
        if (aankoopBedrag < 75){
            ...
            System.out.println("De klant krijgt 10% korting, het aankoop bedrag is nu: " +aankoopBedrag * 0.9);
        }
        else if (aankoopBedrag >= 300.01){
            System.out.println("De klant krijg 16% korting, het aankoop bedrag is nu: " +aankoopBedrag * 0.84);
        }
        else{
            System.out.println("Het aankoop bedrag is ongeldig!");
        }
